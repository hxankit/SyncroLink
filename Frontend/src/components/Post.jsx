...
const Post = ({ post }) => {
  ...
  const likeOrDislikeHandler = async () => {
    try {
      ...
      const res = await axios.get(`https://syncrolink.onrender.com/api/v1/post/${post._id}/${action}`, { withCredentials: true });
      if (res.data.success) {
  ...
  const commentHandler = async () => {
    try {
      const res = await axios.post(`https://syncrolink.onrender.com/api/v1/post/${post._id}/comment`, { text }, {
  ...
  const deletePostHandler = async () => {
    try {
      const res = await axios.delete(`https://syncrolink.onrender.com/api/v1/post/delete/${post?._id}`, { withCredentials: true })
      if (res.data.success) {
  ...
  const bookmarkHandler = async () => {
    try {
      const res = await axios.get(`https://syncrolink.onrender.com/api/v1/post/${post._id}/bookmark`, { withCredentials: true });
      if (res.data.success) {
        toast.success(res.data.message);
      }
    } catch (error) {
